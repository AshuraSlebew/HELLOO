...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'AshuraSlayerz' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = 'ASHURA BOT' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'AshuraSlayerz' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
// Other
global.owner = ['0182646681']
global.premium = ['0182646681']
global.packname = 'AshuraSlayerz'
global.ownerr = ['AshuraSlayerz']
global.author = 'HAIKAL TZY'
...
global.mess = {
    ...
    verif: 'Hai Kakak 👋 Silahkan Verifikasi Terlebih Dahulu Agar Bisa Menggunakan Ashura Bot',
}
//=================================================//
